  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6">
        <select className="border rounded px-4 py-2 text-sm w-full md:w-auto">
        ...
        <button className="flex items-center gap-2 px-4 py-2 bg-blue-700 text-white rounded hover:to-blue-900">

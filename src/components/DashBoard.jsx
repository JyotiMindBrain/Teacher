...
import { FaFileMedical, FaUserGraduate, FaMapMarkerAlt } from "react-icons/fa";
...
export default function Dashboard() {
    ...
    const links = [
        { name: "Attendance marking", icon: <FiFileText className="text-blue-700 text-4xl" />, path: "/classroom/attendance" },
        { name: "Assignment grading", icon: <FaUserGraduate className="text-blue-700 text-4xl" />, path: "/classroom/assignments_view" },
        { name: "Create Assignment", icon: <FaFileMedical className="text-blue-700 text-4xl" />, path: "/classroom/assignments" },
                    ...
                    <section className="lg:col-span-2 bg-white p-4 rounded-lg shadow">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {scheduleData.map((item, idx) => (
                                <div
                                    key={idx}
                                    className={`bg-white p-4 rounded-lg shadow border-l-4 ${colorClasses[item.color].border}`}
                                >
                                    {/* Top Row: Time + Status */}
                    ...
                    <section className="bg-white p-4 rounded-lg shadow">
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div
                                    key={idx}
                                    className={`flex justify-between items-center p-4 bg-white rounded-lg shadow border-l-4 

    ...
    return (
        <div className="p-6">
            ...
            <div className="flex gap-2 mb-6">
                ...
                <Link to="/discussion" className="bg-blue-700 text-white border ml-4 border-gray-300 px-4 py-2 rounded-md text-sm flex items-center justify-center hover:bg-blue-900 hover:text-white">
                    Discussion Forum
                </Link>
            </div>
            <div className="flex flex-col sm:flex-row h-screen font-sans">
                {/* Left Panel - Recent Questions */}
                <div className="sm:w-[30%] w-full bg-gray-100 p-4 border-r">
